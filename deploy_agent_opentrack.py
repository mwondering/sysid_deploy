...
if __name__ == "__main__":
    ...
    if args.env == 'mujoco':
        ...
        env = MujocoEnv(object_name=args.object_name)
    elif args.env == 'real':
    ...
    #     '/home/lenovo/BeyondMimic_sjy/logs/rsl_rl/temp/exported/policy_01252f.onnx',
    # ]
    ...
    opentrack_path_list = [
        '/home/lenovo/OpenTrack/experiments/lafan1_generalist_v1.0/checkpoints/000000000001/policy_d1s1.onnx',
    ]
    for idx,opentrack_path in enumerate(opentrack_path_list):
        print(idx)
        print("opentrack_path:", opentrack_path)
        main_controller.add_controller(OpentrackControllerXingyiSysID(config_path="/home/lenovo/OpenTrack/experiments/lafan1_generalist_v1.0/checkpoints/config.json",policy_path=opentrack_path))
